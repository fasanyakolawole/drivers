...
public final class ActivityPendingOrdersBinding implements ViewBinding {
  ...
  private ActivityPendingOrdersBinding(@NonNull FrameLayout rootView,
  ...
  public static ActivityPendingOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPendingOrdersBinding((FrameLayout) rootView, progressBar, recyclerView,
